...
$MESS["SAVE_PASSWORD"]="Запомнить меня";
$MESS["CLOSE_PASSWORD"]="Закрыть";
$MESS["REGISTR_PASSWORD"]="Зарегистрироваться";
$MESS["OUT_PASSWORD"]="Выйти";
$MESS["SIGN_IN_PASSWORD"]="Войти на сайт";
?>