...
{
    copy(WIZARD_ABSOLUTE_PATH."/site/no_data/_index.php",$_SERVER["DOCUMENT_ROOT"]."/_index.php");
    copy(WIZARD_ABSOLUTE_PATH."/site/public/ru/urlrewrite.php",$_SERVER["DOCUMENT_ROOT"]."/urlrewrite.php"); 
    copy(WIZARD_ABSOLUTE_PATH."/site/public/ru/include/news.php",$_SERVER["DOCUMENT_ROOT"]."/include/news.php");
